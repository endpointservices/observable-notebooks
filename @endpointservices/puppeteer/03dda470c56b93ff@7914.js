...
import define3 from "./e3a019069a130d79@5762.js";
...
import define9 from "./db42ae70222a8b08@492.js";
  ...
  return new Map(
    await Promise.all(
      [
        ...
        if (spec.name === "d/c79389fb505251fc") debugger;
    ...
    ? await Promise.all(
        [...module.fileAttachments.entries()].map(
          async ([name, attachment]) => {
            ...
            if (name.includes("disk")) debugger;
