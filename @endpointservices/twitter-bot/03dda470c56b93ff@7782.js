...
function _parameters(Inputs,exporter,default_style,localStorageView){return(
Inputs.bind(
  exporter({ style: default_style }),
...
({ handler = actionHandler, style = default_style } = {}) => {
...
function _34(Inputs,module_specs){return(
Inputs.table(
  [
...
function _book(lopebook,module_specs,task){return(
lopebook(
  {
    url: "main",
...
async (bundle, { style } = {}) => `<!DOCTYPE html>
<meta charset="UTF-8">
...
function _61(test_notebook_module,variableToObject){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof parameters")).define("viewof parameters", ["Inputs","exporter","default_style","localStorageView"], _parameters);
  ...
  main.variable(observer()).define(["task"], _18);
  ...
  main.variable(observer()).define(["Inputs","module_specs"], _34);
  main.variable(observer("book")).define("book", ["lopebook","module_specs","task"], _book);
  ...
  main.variable(observer()).define(["test_notebook_module","variableToObject"], _61);
