...
import define4 from "./98f34e974bb2e4bc@659.js";
...
function _main_modules(runtime,modules,builtin)
{
...
function _summary(main_modules,builtin,notebookImportMatches,resolve_modules,module_definition_variables)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("main_modules")).define("main_modules", ["runtime","modules","builtin"], _main_modules);
  ...
  main.variable(observer("summary")).define("summary", ["main_modules","builtin","notebookImportMatches","resolve_modules","module_definition_variables"], _summary);
