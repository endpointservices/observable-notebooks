...
import define5 from "./64057d42235a0057@2907.js";
...
function _152(test_case){return(
test_case.value
)}
...
function _154(parser,test_case)
{
  const comments = [];
  const tokens = [];
...
function _156(compiled_selector,normalizeJavascriptSource){return(
JSON.stringify(
  {
    ...compiled_selector,
...
function _157(compile,test_case){return(
compile(test_case.value)
)}

function _158(normalizeVariables,test_case){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["test_case"], _152);
  main.variable(observer("compiled")).define("compiled", ["compile","test_case"], _compiled);
  main.variable(observer()).define(["parser","test_case"], _154);
  ...
  main.variable(observer()).define(["compiled_selector","normalizeJavascriptSource"], _156);
  main.variable(observer()).define(["compile","test_case"], _157);
  main.variable(observer()).define(["normalizeVariables","test_case"], _158);
