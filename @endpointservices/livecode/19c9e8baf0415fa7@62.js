// https://observablehq.com/@mbostock/poisson-disk-sampling@62
function _1(md){return(
md`# Poisson Disk Sampling`
)}

function _2(samples){return(
[...samples([0, 0, 1000, 1000], 100)]
)}

function _samples(){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["samples"], _2);
  main.variable(observer("samples")).define("samples", _samples);
  return main;
}
