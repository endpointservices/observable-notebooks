...
`
  ...
  main.define("initial msgs", function(){return(
...
`
  ...
  main.variable(observer()).define(["msgs","mutable msgs","html"], function(msgs,$0,html)
{
...
`
  ...
  main.variable(observer()).define(["msgs","mutable msgs","reconcile","html"], function(msgs,$0,reconcile,html)
{
...
`
  ...
  main.variable(observer("morph")).define("morph", ["require"], function(require){return(
require('https://bundle.run/nanomorph@5.4.2')
)});
  main.variable(observer("reconcile")).define("reconcile", ["morph"], function(morph){return(
...
md `# Tests`
  ...
  main.variable(observer("attributeCreate")).define("attributeCreate", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("attributeRemoved")).define("attributeRemoved", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("attributeUpdate")).define("attributeUpdate", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("attributesCRUD")).define("attributesCRUD", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("childUpdateInPlace")).define("childUpdateInPlace", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("childAdded")).define("childAdded", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("childRemoved")).define("childRemoved", ["html","reconcile"], function(html,reconcile)
{
  ...
  main.variable(observer("keyedChildUpdateInPlace")).define("keyedChildUpdateInPlace", ["html","reconcile"], function(html,reconcile)
{
  const current = html`<ul><li id="t1"></li></ul>`
  ...
  main.variable(observer("DOMUpdateInPlaceDOM")).define("DOMUpdateInPlaceDOM", ["html"], function(html){return(
html`
<div id="DOMUpdateInPlace"> 
</div>
`
)});
  main.variable(observer("DOMUpdateInPlace")).define("DOMUpdateInPlace", ["DOMUpdateInPlaceDOM","html","reconcile"], function(DOMUpdateInPlaceDOM,html,reconcile)
{
  DOMUpdateInPlaceDOM
  ...
  main.variable(observer("NestedDOMUpdateInPlaceDOM")).define("NestedDOMUpdateInPlaceDOM", ["html"], function(html){return(
html`
<div id="NestedDOMUpdateInPlace"><p>
    <b>raw</b>
</p></div>`
)});
  main.variable(observer("NestedDOMUpdateInPlace")).define("NestedDOMUpdateInPlace", ["NestedDOMUpdateInPlaceDOM","html","reconcile"], function(NestedDOMUpdateInPlaceDOM,html,reconcile)
{
