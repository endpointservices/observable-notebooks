...
`
  ...
  main.variable(observer()).define(["width","html"], function(width,html)
{
...
md`##### Implementation`
  ...
  main.variable(observer("endpoint")).define("endpoint", ["deploy"], function(deploy){return(
deploy
)});
  main.variable(observer("deploy")).define("deploy", ["baseDeploy","serverlessCellUI","subdomain"], function(baseDeploy,serverlessCellUI,subdomain){return(
