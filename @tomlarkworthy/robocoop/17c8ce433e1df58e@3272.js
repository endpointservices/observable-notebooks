...
import define2 from "./e3a019069a130d79@4832.js";
...
import define11 from "./dfdb38d5580b5c35@334.js";
...
async function _code(events,runtimeCells,decompile){return(
events &&
  Object.fromEntries(
    await Promise.all(
      [...runtimeCells.entries()].map(async ([name, variables]) => [
        name,
        {
...
function _runtimeCells(cellMap,runtime,main){return(
cellMap(runtime, main)
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("code")).define("code", ["events","runtimeCells","decompile"], _code);
  main.variable(observer("variables")).define("variables", ["_mainVariables","excludes"], _variables);
  main.variable(observer("runtimeCells")).define("runtimeCells", ["cellMap","runtime","main"], _runtimeCells);
  ...
  main.variable(observer()).define(["ask"], _55);
