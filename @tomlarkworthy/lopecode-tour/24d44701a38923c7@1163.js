import define1 from "./8381f40adb144e29@51.js";
import define2 from "./2ff342bf285f0043@458.js";
import define3 from "./db42ae70222a8b08@1033.js";
import define4 from "./de3abeb05c4b090e@754.js";
import define5 from "./a6a56ee61aba9799@406.js";
import define6 from "./a89ea9f0ad8c6226@1403.js";
import define7 from "./98f34e974bb2e4bc@699.js";
import define8 from "./e3a019069a130d79@6742.js";
import define9 from "./f6282eaf525a00db@2251.js";
import define10 from "./cc0400a7ad6d96d0@2964.js";
import define11 from "./03dda470c56b93ff@8385.js";
import define12 from "./09fdee029150048c@443.js";
import define13 from "./e627aaaaa9857257@1727.js";
import define14 from "./0b75dbddd18995dc@1765.js";
import define15 from "./f096db8fcbc444bf@565.js";
import define16 from "./64057d42235a0057@2912.js";
...
function _82(page){return(
page
)}

function _83(context_menu){return(
context_menu
)}

function _84(background_jobs){return(
background_jobs
)}
...
function _98(setFileAttachment,attachment,tourModule){return(
...
function _104(manipulate,$0,$1,invalidation,invert){return(
manipulate({
  this: this,
  viewofData: $0,
  viewofPlot: $1,
...
function _106(Inputs,x_simple){return(
...
export default function define(runtime, observer) {
  ...
  main.import("page", child10);
  main.import("background_jobs", child10);
  main.import("context_menu", child10);
  main.variable(observer()).define(["page"], _82);
  main.variable(observer()).define(["context_menu"], _83);
  main.variable(observer()).define(["background_jobs"], _84);
  main.variable(observer()).define(["md"], _85);
  main.variable(observer()).define(["md"], _86);
  const child11 = runtime.module(define11);
  main.import("exporter", child11);
  ...
  main.import("createFileAttachment", child12);
  main.import("setFileAttachment", child12);
  main.variable(observer("attachment")).define("attachment", ["note","createFileAttachment"], _attachment);
  main.variable(observer()).define(["setFileAttachment","attachment","tourModule"], _98);
  main.variable(observer()).define(["md"], _99);
  main.variable(observer()).define(["exporter"], _100);
  main.variable(observer()).define(["md"], _101);
  const child13 = runtime.module(define13);
  main.import("manipulate", child13);
  main.import("invert", child13);
  ...
  main.variable(observer()).define(["manipulate","viewof x_simple","viewof plot_simple","invalidation","invert"], _104);
  ...
  main.variable(observer()).define(["Inputs","x_simple"], _106);
  main.variable(observer()).define(["md"], _107);
  const child14 = runtime.module(define14);
  main.import("_ndd", child14);
  main.import("viewof pause", child14);
  main.import("pause", child14);
  main.import("events", child14);
  main.variable(observer()).define(["viewof pause","Event"], _109);
  ...
  main.import("tests", child15);
  main.variable(observer()).define(["tests"], _115);
  ...
  main.import("ui", child16);
  main.variable(observer()).define(["ui"], _120);
