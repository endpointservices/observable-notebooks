...
function _draw(run,zoom,width,height,buffers,t,MAX_SEGMENTS,frames,THREE,gain,dampening,blankingOffset,palette)
{
  if (!run) return;
  const points = [];
  const colors = [];
...
function _MAX_SEGMENTS(frames){return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["ildatest.ild", {url: new URL("./files/3a6051403967a305c976b0c3bb59d25ecc88de7526fc5397033fe9689ad194cfe93febf4bb9e9fefdb8b853ca0621ad6e20fbf6fb9b8993e4b9bee82027477ff.bin", import.meta.url), mimeType: "application/octet-stream", toString}]
  ]);
  ...
  main.variable(observer("draw")).define("draw", ["run","zoom","width","height","buffers","t","MAX_SEGMENTS","frames","THREE","gain","dampening","blankingOffset","palette"], _draw);
  ...
  main.variable(observer("MAX_SEGMENTS")).define("MAX_SEGMENTS", ["frames"], _MAX_SEGMENTS);
