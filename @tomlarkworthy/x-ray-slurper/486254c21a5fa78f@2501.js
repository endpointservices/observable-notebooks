...
function _16(Inputs,$0,trace_ids_list){return(
Inputs.button("load", {
  label: "load list",
  reduce: () => {
    $0.send({
...
function _23(exportDuckDB,db,filename,htl){return(
...
__query(segment_tree,{from:{table:"segment_tree"},sort:[],slice:{to:null,from:null},filter:[{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"rum-prod"}]},{type:"ne",operands:[{type:"column",value:"url"},{type:"resolved",value:"https://flow-api.cp.taktile.com/api/v1/flow_versions/f458e344-f61f-41a8-ad47-e0efb4b92859"}]},{type:"ne",operands:[{type:"column",value:"url"},{type:"resolved",value:"https://taktile-api.cp.taktile.com/api/v1/organizations/5cdcc72d-5745-47ea-8451-0dcf56b8e49b/logo"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"flow-api.cp.taktile.com"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"taktile-api.cp.taktile.com"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"do-archiver-prod-b2b-bnpl-X2df"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"do-archiver-prod-risk-X391"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"do-archiver-prod-risk-X16c"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"do-archiver-prod-risk-X1cf"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"do-archiver-prod-txn-taggin-Xd3b"}]},{type:"ne",operands:[{type:"column",value:"name"},{type:"resolved",value:"do-archiver-prod-credit-ris-Xd17"}]},{type:"eq",operands:[{type:"column",value:"name"},{type:"resolved",value:"Attempt #1"}]}],select:{columns:["start_time","end_time","TraceId","pageId","method","url","status","name","parent","Id"]}},invalidation,"segment_tree")
)}
...
function _35(Plot,root_segments,width){return(
...
function _41(root_segments){return(
root_segments
)}
...
function _44(__query,selected_trace,invalidation){return(
...
function _47(d3,DOM,width,single_height,single_trace,d3FlameGraph)
{
...
function _51(Plot,root_segments){return(
Plot.auto(root_segments, {x: "duration"}).plot()
)}

function _52(d3,root_segments,md){return(
...
function _55(Plot,perf,width){return(
Plot.auto(perf, {x: "duration", y: "name", mark: "dot"}).plot({width, marginLeft: 500})
)}
...
function _58(d3,DOM,width,height,flamegraph_chart_data,d3FlameGraph)
{
...
function _61(Plot,flamegraph_data,width){return(
Plot.auto(flamegraph_data, {x: "value", y: "name"}).plot({width, marginLeft: 400})
)}

function _62(Plot,flamegraph_data){return(
...
function _67(__query,db_refresh,invalidation){return(
...
function _69(__query,db_refresh,invalidation){return(
...
function _73(__query,db,invalidation){return(
...
function _76(traces){return(
new Date(JSON.parse(traces.Traces[0].Segments[0].Document).start_time * 1000)
)}

function _77(traces){return(
traces
)}

function _78(traces){return(
...
function _81(insert_traces,db,traces){return(
insert_traces &&
...
function _83(insert_traces,$0){return(
...
function _loadTracesInBatch(batch,$0,$1)
{
  const ids = batch.TraceSummaries.map((summary) => summary.Id);
  for (let i = 0; i < ids.length; i = i + 5) {
    $0.send(ids.slice(i, i + 5));
  }
  $1.resolve(ids);
  return ids;
}
...
function _92(traces,$0){return(
traces && $0.value++
)}

function _93($0,insert_traces){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Inputs","viewof batch","trace_ids_list"], _16);
  ...
  main.variable(observer()).define(["viewof access_key","viewof access_secret_key","Event"], _20);
  ...
  main.variable(observer()).define(["exportDuckDB","db","filename","htl"], _23);
  ...
  main.variable(observer()).define(["Plot","root_segments","width"], _35);
  ...
  main.variable(observer()).define(["root_segments"], _41);
  main.variable(observer()).define(["md"], _42);
  main.variable(observer("selected_trace")).define("selected_trace", ["segment_tree","selected"], _selected_trace);
  main.variable(observer()).define(["__query","selected_trace","invalidation"], _44);
  ...
  main.variable(observer()).define(["d3","DOM","width","single_height","single_trace","d3FlameGraph"], _47);
  ...
  main.variable(observer()).define(["Plot","root_segments"], _51);
  main.variable(observer()).define(["d3","root_segments","md"], _52);
  main.variable(observer()).define(["md"], _53);
  main.variable(observer("perf")).define("perf", ["selected_traces"], _perf);
  main.variable(observer()).define(["Plot","perf","width"], _55);
  ...
  main.variable(observer()).define(["d3","DOM","width","height","flamegraph_chart_data","d3FlameGraph"], _58);
  main.variable(observer("flamegraph_data")).define("flamegraph_data", ["selected_traces","db_refresh"], _flamegraph_data);
  main.variable(observer()).define(["md"], _60);
  main.variable(observer()).define(["Plot","flamegraph_data","width"], _61);
  main.variable(observer()).define(["Plot","flamegraph_data"], _62);
  ...
  main.variable(observer()).define(["__query","db_refresh","invalidation"], _67);
  main.variable(observer()).define(["md"], _68);
  main.variable(observer()).define(["__query","db_refresh","invalidation"], _69);
  main.variable(observer()).define(["md"], _70);
  main.variable(observer()).define(["md"], _71);
  main.variable(observer("db")).define("db", ["DuckDBClient"], _db);
  main.variable(observer()).define(["__query","db","invalidation"], _73);
  ...
  main.variable(observer()).define(["traces"], _76);
  main.variable(observer()).define(["traces"], _77);
  main.variable(observer()).define(["traces"], _78);
  ...
  main.variable(observer()).define(["insert_traces","db","traces"], _81);
  main.variable(observer("insert_traces")).define("insert_traces", ["segments_table","traces","db"], _insert_traces);
  main.variable(observer()).define(["insert_traces","mutable refresh_db"], _83);
  ...
  main.variable(observer("loadTracesInBatch")).define("loadTracesInBatch", ["batch","viewof trace_ids","viewof batch"], _loadTracesInBatch);
  ...
  main.variable(observer()).define(["traces","mutable batches_fetched"], _92);
  main.variable(observer()).define(["viewof trace_ids","insert_traces"], _93);
