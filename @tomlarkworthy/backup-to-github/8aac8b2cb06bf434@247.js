...
import define1 from "./58f3eb7334551ae6@153.js";
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["onVersion","md"], function(onVersion,md){return(
...
3
  ...
  main.variable(observer()).define(["onVersion"], function(onVersion){return(
onVersion((metadata) => {
  fetch(
...
We check to see if the URL is prefixed with /thumbnail`
  ...
  main.variable(observer("extractMetadata")).define("extractMetadata", function(){return(
(pathname) => {
  ...
  main.variable(observer("onVersion")).define("onVersion", ["extractMetadata","html"], function(extractMetadata,html){return(
async (work) => {
