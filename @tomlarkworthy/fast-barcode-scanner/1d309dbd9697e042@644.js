...
function _enableGithubBackups(onVersion,getMetadata,dispatchProxyName,createDispatchProxy){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("enableGithubBackups")).define("enableGithubBackups", ["onVersion","getMetadata","dispatchProxyName","createDispatchProxy"], _enableGithubBackups);
