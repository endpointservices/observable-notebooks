// https://observablehq.com/@tomlarkworthy/animated-sequence-diagrams@179
...
md`The original version of this notebook justed used the \`?\` operator against the \`step\` value on the mermaid source code to create the animation effect. This annoyed people because the source was very messy, the [@mootari](/@mootari) helpfully donated the following helper: `
)}
