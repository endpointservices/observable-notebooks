import define1 from "./f550ddbdb36998cb@125.js";
import define2 from "./17c8ce433e1df58e@3318.js";
import define3 from "./c7a3b20cec5d4dd9@727.js";
...
async (v) => {
  if (v._name === "viewof aslias_viewdep") {
    debugger;
  }
  if (
...
function _module_0_decompiled(decompile,semanticsCells){return(
decompile(semanticsCells.get("module 0"))
)}
...
function _34(parser,notebook_semantics_source){return(
parser.parseCell(notebook_semantics_source[23].value)
)}
...
function _36(highlight,test_cases){return(
...
function _41(highlight,decompilation_test_results){return(
...
function _71(highlight,compilation_test_results){return(
highlight(compilation_test_results)
)}

function _72(test_cases,compilationSuite,expect,normalizeVariables,compile){return(
...
function _76(parser,test_case){return(
...
function _78(compiled_selector,normalizeJavascriptSource){return(
JSON.stringify(
  {
    ...compiled_selector,
...
function _79(compile,test_case){return(
compile(test_case.source.value)
)}

function _80(normalizeVariables,test_case){return(
...
function _82(highlight,singleCompileTest){return(
...
function _88(Inputs,suggestion){return(
...
function _99(ask){return(
ask
)}

function _100(api_call_response){return(
api_call_response
)}

function _101(background_tasks){return(
background_tasks
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("module_0_decompiled")).define("module_0_decompiled", ["decompile","semanticsCells"], _module_0_decompiled);
  main.variable(observer()).define(["md"], _31);
  main.variable(observer()).define(["md"], _32);
  main.variable(observer()).define(["md"], _33);
  main.variable(observer()).define(["parser","notebook_semantics_source"], _34);
  ...
  main.variable(observer()).define(["highlight","test_cases"], _36);
  ...
  main.variable(observer()).define(["highlight","decompilation_test_results"], _41);
  ...
  main.variable(observer()).define(["highlight","compilation_test_results"], _71);
  main.variable(observer()).define(["test_cases","compilationSuite","expect","normalizeVariables","compile"], _72);
  ...
  main.variable(observer()).define(["parser","test_case"], _76);
  ...
  main.variable(observer()).define(["compiled_selector","normalizeJavascriptSource"], _78);
  main.variable(observer()).define(["compile","test_case"], _79);
  main.variable(observer()).define(["normalizeVariables","test_case"], _80);
  ...
  main.variable(observer()).define(["highlight","singleCompileTest"], _82);
  ...
  main.variable(observer()).define(["viewof prompt"], _87);
  main.variable(observer()).define(["Inputs","suggestion"], _88);
  main.variable(observer()).define(["viewof suggestion"], _89);
  main.variable(observer()).define(["md"], _90);
  main.variable(observer()).define(["viewof context_viz"], _91);
  main.variable(observer()).define(["md"], _92);
  main.variable(observer()).define(["viewof OPENAI_API_KEY"], _93);
  main.variable(observer()).define(["viewof api_endpoint"], _94);
  main.variable(observer()).define(["viewof settings"], _95);
  ...
  main.variable(observer()).define(["ask"], _99);
  main.variable(observer()).define(["api_call_response"], _100);
  main.variable(observer()).define(["background_tasks"], _101);
