...
function _listenNotifiedOfWrite(suite,randomString,rtdb,rootA,rootB,log,_){return(
suite.test(
...
function _42(operations){return(
operations
)}
...
function _server(endpoint,log,$0){return(
...
function _48(incomingLongpollRequest){return(
...
async function _incomingLongpollRequestAction(log,incomingLongpollRequest,createClient,redisConfig,createLongpollSession,newSessionResponse,incrementLongpollResponseNum,$0,disconnectFrame,retrieveLongpollSession,$1,process_operation,next_notify,ack_notify)
{
...
function _54(incomingRequest){return(
incomingRequest
)}

function _requestRouter(log,incomingRequest,$0,$1,$2,$3,$4)
{
...
function _58(incomingStats){return(
incomingStats
)}

function _incomingStatsAction(log,incomingStats,enqueue_notify,$0)
{
...
function _62(incomingPut){return(
incomingPut
)}
...
function _66(incomingGet){return(
incomingGet
)}
...
function _71(incomingQuery){return(
incomingQuery
)}
...
function _80(endpoint,notebookSnapshot){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("log")).define("log", ["viewof rtdbLogs","Event"], _log);
  main.variable(observer("overlay")).define("overlay", ["showOverlay","view","Inputs","viewof rtdbLogs","Event","viewof restartClient","html","makeSticky","invalidation"], _overlay);
  ...
  main.variable(observer()).define(["width","md"], _15);
  ...
  main.variable(observer()).define(["viewof restartClient"], _30);
  ...
  main.variable(observer("listenNotifiedOfWrite")).define("listenNotifiedOfWrite", ["suite","randomString","rtdb","rootA","rootB","log","_"], _listenNotifiedOfWrite);
  ...
  main.variable(observer()).define(["operations"], _42);
  main.variable(observer("redisConfig")).define("redisConfig", _redisConfig);
  main.variable(observer()).define(["md"], _44);
  main.variable(observer("server")).define("server", ["endpoint","log","viewof incomingLongpollRequest"], _server);
  ...
  main.variable(observer()).define(["incomingLongpollRequest"], _48);
  ...
  main.variable(observer("incomingLongpollRequestAction")).define("incomingLongpollRequestAction", ["log","incomingLongpollRequest","createClient","redisConfig","createLongpollSession","newSessionResponse","incrementLongpollResponseNum","viewof incomingLongpollRequest","disconnectFrame","retrieveLongpollSession","viewof incomingRequest","process_operation","next_notify","ack_notify"], _incomingLongpollRequestAction);
  ...
  main.variable(observer()).define(["incomingRequest"], _54);
  main.variable(observer("requestRouter")).define("requestRouter", ["log","incomingRequest","viewof incomingStats","viewof incomingPut","viewof incomingQuery","viewof incomingGet","viewof incomingRequest"], _requestRouter);
  ...
  main.variable(observer()).define(["incomingStats"], _58);
  main.variable(observer("incomingStatsAction")).define("incomingStatsAction", ["log","incomingStats","enqueue_notify","viewof incomingStats"], _incomingStatsAction);
  ...
  main.variable(observer()).define(["incomingPut"], _62);
  ...
  main.variable(observer()).define(["incomingGet"], _66);
  ...
  main.variable(observer()).define(["incomingQuery"], _71);
  ...
  main.variable(observer()).define(["endpoint","notebookSnapshot"], _80);
