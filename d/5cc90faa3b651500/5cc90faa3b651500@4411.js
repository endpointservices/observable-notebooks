...
function _78(explode){return(
explode
)}

function _79(explode){return(
explode
)}
...
function _87(Inputs,suggestion){return(
...
function _92($0){return(
$0
)}

function _93(feedback_prompt){return(
feedback_prompt
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["html","deps"], _67);
  ...
  main.variable(observer()).define(["explode"], _78);
  main.variable(observer()).define(["explode"], _79);
  ...
  main.variable(observer()).define(["viewof prompt"], _85);
  main.variable(observer()).define(["md"], _86);
  main.variable(observer()).define(["Inputs","suggestion"], _87);
  main.variable(observer()).define(["viewof suggestion"], _88);
  main.variable(observer()).define(["md"], _89);
  main.variable(observer()).define(["viewof context_viz"], _90);
  main.variable(observer()).define(["md"], _91);
  main.variable(observer()).define(["viewof feedback_cells_selector"], _92);
  main.variable(observer()).define(["feedback_prompt"], _93);
  main.variable(observer()).define(["md"], _94);
  main.variable(observer()).define(["viewof OPENAI_API_KEY"], _95);
  main.variable(observer()).define(["viewof api_endpoint"], _96);
  main.variable(observer()).define(["viewof settings"], _97);
  main.variable(observer()).define(["md"], _98);
  main.variable(observer()).define(["source"], _99);
