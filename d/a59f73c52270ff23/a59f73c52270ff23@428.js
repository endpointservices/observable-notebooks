...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["month","md"], function(month,md){return(
...
md`${content}`
  ...
  main.variable(observer("content")).define("content", ["cutoff","data","month"], function(cutoff,data,month)
{
  let markdown = "";
...
md`### Data wrangling`
  ...
  main.variable(observer("month")).define("month", function(){return(
"February"
)});
