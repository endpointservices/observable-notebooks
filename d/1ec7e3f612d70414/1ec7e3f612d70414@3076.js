...
md`# Make a Game Part III - UI all the things
...
function _8(deps){return(
deps.register("BaseSystem", class {}, 1)
)}

function _game_view_v1(deps,htl){return(
{
  prompt:
    "lets a do a new game_view with the origin in the middle and the corners -1 and 1",
  time: 1699906480550,
  comment:
...
function _GameLoop_v2(deps,entities,game_view,gameState)
{
  ({
    prompt:
...
function _ship_template_v2(htl,assets)
{
  ({
    prompt:
...
function _ship_template_v3(ship_template_v2,view,Inputs,htl,assets)
{
  ({
    prompt:
...
function _startGameButton_v2(view,game_view,gameState,entities,Event){return(
{
  prompt:
...
function _39(Inputs,suggestion){return(
...
function _45(feedback_prompt){return(
feedback_prompt
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["deps"], _8);
  main.variable(observer("game_view_v1")).define("game_view_v1", ["deps","htl"], _game_view_v1);
  ...
  main.variable(observer("GameLoop_v2")).define("GameLoop_v2", ["deps","entities","game_view","gameState"], _GameLoop_v2);
  main.variable(observer("ship_template_v2")).define("ship_template_v2", ["htl","assets"], _ship_template_v2);
  ...
  main.variable(observer("viewof ship_template_v3")).define("viewof ship_template_v3", ["ship_template_v2","view","Inputs","htl","assets"], _ship_template_v3);
  ...
  main.variable(observer("viewof startGameButton_v2")).define("viewof startGameButton_v2", ["view","game_view","gameState","entities","Event"], _startGameButton_v2);
  ...
  main.variable(observer()).define(["gameState"], _37);
  main.variable(observer()).define(["viewof prompt"], _38);
  main.variable(observer()).define(["Inputs","suggestion"], _39);
  main.variable(observer()).define(["viewof suggestion"], _40);
  main.variable(observer()).define(["md"], _41);
  main.variable(observer()).define(["viewof context_viz"], _42);
  main.variable(observer()).define(["md"], _43);
  main.variable(observer()).define(["viewof feedback_cells_selector"], _44);
  main.variable(observer()).define(["feedback_prompt"], _45);
